...
# datasets 
parser.add_argument('-dataset_path',type=str,default='D:/毕设设计1/缺陷检测代码/Chapter2/skin_disease_two_classification-master/AMHNet程序/dataset/data',help='the path to save imgs')
