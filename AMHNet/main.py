...
def main():
    ...
    now_model_name = 'model2'
    dict = '/media/tao/新加卷/LMH/code/skin_disease_two_classification-master/skin_two_classification_test2/result_concrete/'
    ...
    plt.savefig(
        '/media/tao/新加卷/LMH/code/skin_disease_two_classification-master/skin_two_classification_test2/result_concrete/model2.png')
